(function () {
        ...
        <div class="blog-card__body">
          ...
          <div class="blog-card__meta">
            ...
            <div class="blog-card__link">
              <a class="btn btn--line" href="${href}">Читать</a>
            </div>
          </div>
        </div>
      </article>
  ...
  function renderPagination(totalPages, currentPage) {
    ...
    items.push(
      currentPage > 1
        ? `<a class="blog-pagination__btn" href="${buildPageHref(currentPage - 1)}" aria-label="Предыдущая страница">←</a>`
    ...
    items.push(
      currentPage < totalPages
        ? `<a class="blog-pagination__btn" href="${buildPageHref(currentPage + 1)}" aria-label="Следующая страница">→</a>`
        : `<span class="blog-pagination__btn is-disabled" aria-hidden="true">→</span>`
    );
  ...
  fetch(jsonPath)
    ...
    .catch(() => {
      if (gridEl) {
        gridEl.innerHTML = '<p class="blog-index__lead">Не удалось загрузить статьи. Пожалуйста, обновите страницу.</p>';
      }
    });
})();
